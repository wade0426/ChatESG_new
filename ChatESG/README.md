...
2. **組織管理相關頁面**
   - **創建組織頁面 (found_organization.vue)**
     ...
     - 組織描述輸入
     - 組織標誌上傳和更改
   - **組織主頁面 (OrganizationDashboard.vue)**
     - 組織基本訊息展示 (組織名稱、組織擁有者、組織成員數量、組織報告書數量、組織身份組數量)
     - 組織名稱和描述編輯(僅限組織擁有者)
     - 組織標誌更換(僅限組織擁有者)
     - 組織刪除功能（僅限擁有者）
   - **報告書設定頁面 (ReportManagement.vue)**
     - 僅限組織管理員進入
     - 報告書發布與分享管理
       - 完成審核的報告書發布功能
       - 設定公開或僅限組織內查看
     ...
     - 刪除報告書功能 (僅允許管理員刪除報告書)
   - **成員申請審核頁面 (MembershipApplicationReview.vue)**
     - 人員申請加入組織審核
     - 批量審核
   - **組織身份組頁面 (OrganizationRole.vue)**
     - 身份組列表
     - 身份組管理
   - **組織成員頁面 (OrganizationMember.vue)**
     - 組織成員列表與管理 (移除成員)
     - 組織成員權限管理 (身份組分配，分配成員至身份組，新增、刪除、編輯身份組)
     - 擁有者身份組管理（每個組織僅限一位擁有者），擁有者也會有管理員身份組
     <!-- - 成員多重身份組管理（允許一個成員擁有多個身份組，如管理員和資訊部） (系統在權限判斷上需要明確定義，避免權限衝突或遺漏。) 擁有者>管理員 (暫時不實作) -->
   - **組織權限頁面 (OrganizationPermission.vue)**
     - 組織權限管理
     - 定義誰可以進到組織管理介面
